...
%====================================================
% Arquitectura SIMPLE: Input -> Conv+ReLU -> Flatten -> FC -> Softmax
%====================================================
...
% HxW: MISMA POSICIÓN HORIZONTAL (como sobre el volumen), pero desplazado hacia arriba
\node[lab, above=8pt of X-nw, anchor=south west] {$H\times W$};

% C: a la derecha para no encimar
...
% HxW desplazado hacia arriba (manteniendo alineación vertical)
