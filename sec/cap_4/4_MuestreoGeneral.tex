...
\subsection{Construcción de superficies a partir de símplices}
...
\subsection{Transformación superficie a gráfica}
...
\]
de modo que la gráfica no sólo mantiene su estructura combinatoria, sino también su inserción geométrica en el espacio tridimensional. Esto permite visualizar el grafo respetando la forma de la superficie original.
...
\node[font=\Large\bfseries] at (3.8,6.7) {Original Graph};
\node[font=\Large\bfseries] at (15.2,6.7) {Minimum Spanning Tree};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.62\textwidth]{img/algoritmo.png}
    \caption{Descripción de algoritmo resultante}
    \label{fig:muestreo_esfera}
\end{figure}

\section{Reasignación de adyacencias para preservar la estructura}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.3\textwidth]{img/adyacencias1.png}
    \caption{Algoritmo para la eliminación de nodos con redistribución de adyacencias.}
    \label{fig:elimina_nodo_adyacencias}
\end{figure}
