...
El objetivo del entrenamiento es minimizar la función de pérdida en promedio sobre todo el conjunto de datos, es decir el objetivo del aprendizaje consiste en resolver el problema de optimización
\[
