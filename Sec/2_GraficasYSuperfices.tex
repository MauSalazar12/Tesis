...
\begin{definition}(Espacio topológico)
    ...
    \begin{enumerate}
        \item Si $\{A_i\}_{i \in \mathcal{I}} \subseteq A$, $\mathcal{I}$ arbitrario, entonces \(\displaystyle \bigcup_{i \in \mathcal{I}} A_i \in \mathcal{A}\).
        \item Si $\{A_i\}_{i \in \mathcal{I}} \subseteq A$, $\mathcal{I}$ finito, entonces $\bigcap_{i \in \mathcal{I}} A_i \in \mathcal{A}$
    \end{enumerate}
...
\begin{definition}(Espacio de Hausdorf)
    Sea $(X,\mathcal{A})$ un espacio topológico  es un \textbf{Espacio de Hausdorf}, si para cualesquiera dos puntos distintos de $X$ poseen vecindades ajenas, es decir para dos puntos $x \neq y $ en $X$ existe $U \in \mathcal{N}_x$ y $V \in \mathcal{N}_Y$ tal que $U \cap V = \emptyset$ .
\end{definition}
...
\begin{definition}(Espacio 2-numerable)
...
\begin{definition}
    (Superficie)\\
        Una $2-variedad$ $S$ es una superficie.
\end{definition}
