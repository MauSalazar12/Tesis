...
La teoría de gráficas y el estudio de superficies son dos ramas de las matemáticas que en primera instancia podrían parecer agenas entre sí. Sin embargo a lo largo de este capítulo 
veremos que ambas están relacionadas a través de la implementación de triangulaciones sobre las superficies. 
En particular la representación de superficies a través de gráficas proporciona una nueva perspectiva que permite estudiar propiedades topológicas de otros objetos matemáticos 
conocidos cómo nudos.\\
...
\end{tikzpicture}
    \label{fig:silla}
    \caption{Ejemplo de superficie}
\end{figure}
\begin{flushleft}
En la figura \ref{fig:silla} se puede observar una superficies en $\mathbb{R}^3$ comúnmente conocida como "Silla de montar"
\end{flushleft}
