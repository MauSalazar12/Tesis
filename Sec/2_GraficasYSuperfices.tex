...
\end{example}
 ...
 Uno de los conceptos fundamentales que se introducirán y además se implementarán en la creación de los algoritmos de la sección final es el concepto de caminos, este concepto se utilizará cómo herrramienta para el estudio y recorrido de la gráfica completa.
...
\begin{example}
   \begin{figure}[H]
    ...
    \foreach \from/\to in {n1/n2, n2/n3, n3/n4, n3/n5, n5/n1}
        \draw (\from) -- (\to);
    ...
    \end{tikzpicture}
    \caption{Ejemplo de gráfica conexa}
    \label{fig:conexa}
\end{figure}
\end{example}
 ...
 \begin{example}
    ...
    \foreach \from/\to in {a1/a2,a1/a3,a2/a4,a3/a4}
        \draw (\from) -- (\to);
    ...
    \foreach \from/\to in {b1/b2,b2/b3,b3/b1}
        \draw (\from) -- (\to);

    \end{tikzpicture}
    \caption{Ejemplo de un grafo con dos componentes conexas}
...
\end{figure}
 ...
 \begin{example}
    ...
    \foreach \from/\to in {a1/a2,a1/a3,a2/a3}
        \draw (\from) -- (\to);
    ...
    \end{tikzpicture}
    \caption{Ejemplo de grafo con un puente (arista de corte)}
    \label{fig:puente}
\end{figure}
